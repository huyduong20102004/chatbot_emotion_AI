...
def remove_stopwords(text, stopword_file=r'd:\DAP391m\Assigment final\Assignment_DAP - Copy - Copy\stopword_1.txt'):
...
input_sentence_1 = "Tôi đang buồn :D"
result_1 = process_text(input_sentence_1)

print(f"Kết quả câu 1: {result_1}")
